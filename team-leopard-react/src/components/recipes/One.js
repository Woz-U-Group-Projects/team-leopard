...
function Page() {
    return (
        <>
            <div id="backgroundImageContainer" className="page-holder bg-cover-recipe">
        ...
        <>
            <div className="card mb-3 card-recipe centered-card text-center">
                ...
                <div className="card-body">
                    <h6 className="card-subtitle text-muted">Serving size <span className="badge badge-pill badge-success">6</span></h6>
                </div>
